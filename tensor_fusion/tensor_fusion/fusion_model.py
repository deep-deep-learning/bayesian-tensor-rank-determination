...
class AdaptiveRankFusion_with_AdaptiveRankSubNets(nn.Module):
    ...
    def __init__(self, input_sizes, hidden_sizes, dropouts, output_size, bias=False,
                 max_rank=10, tensor_type='CP', prior_type='log_uniform', eta=None,
        ...
        args:
            ...
            dropouts: a tuple of floats, (dropout_1, dropout_2, ..., dropout_M)
...
class AdaptiveRankFusion_with_AdaptiveRankSubNets_2(nn.Module):
    ...
    def __init__(self, input_sizes, hidden_sizes, dropouts, output_size, bias=False,
        ...
        self.post_fusion_subnet = AdaptiveRankTensorizedSubNet(output_size, 1, dropouts[-1], bias=bias,
                                                               max_rank=max_rank, tensor_type=tensor_type, prior_type=prior_type, eta=eta,
                                                               device=device, dtype=dtype)
    ...
    def forward(self, audio_x, video_x, text_x):
        ...
        output = self.fusion_layer([audio_h, video_h, text_h])
        output = self.post_fusion_subnet(output)
    ...
    def get_log_prior(self):
        ...
        return self.audio_subnet.get_log_prior() + self.text_subnet.get_log_prior() + self.video_subnet.get_log_prior() + \
            self.fusion_layer.get_log_prior() + self.post_fusion_subnet.get_log_prior()
