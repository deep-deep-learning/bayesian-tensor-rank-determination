...
$dlrm_pt_bin --arch-sparse-feature-size=128 --arch-mlp-bot="13-512-256-64-16" --arch-mlp-top="512-256-1" --data-generation=dataset --data-set=kaggle --raw-data-file=./input/train.txt --processed-data-file=./input/kaggleAdDisplayChallenge_processed.npz --loss-function=bce --round-targets=True --mini-batch-size=128 --print-time $dlrm_extra_option --test-num-workers=16 --test-freq=10240 --print-freq=1024 --memory-map --use-gpu 2>&1 | tee run_kaggle_pt.log
